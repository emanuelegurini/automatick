...
9a. For incident or Freshdesk alarm investigations, ask check_cloudwatch to include prior incident history/frequency, internal runbook guidance, and official AWS documentation guidance when available.
