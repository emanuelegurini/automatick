...
This client handles that with retry logic and extended timeouts.
...
MCP_TIMEOUT_SECONDS = 120  # total HTTP timeout for tool calls
MCP_RETRY_ATTEMPTS = 3     # retry on transient cold-start errors
MCP_RETRY_DELAY = 5        # seconds between retries
...
class ResilientMCPClientManager:
    ...
    def get_client(self) -> MCPClient:
        """Return the connected MCPClient, creating and connecting it on first call."""
